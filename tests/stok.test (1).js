...
async function runAllTests() {
    ...
    assertEqual("Autentikasi: Validasi Login Administrator", true, loginSukses.success);
    ...
    assertEqual(`Inventori: Penambahan Item Baru ke Database`, jumlahBarangAwal + 1, APP.products.length);
    ...
    if (produkTest) {
        ...
        assertEqual(`POS: Sinkronisasi Stok via Transaksi (Awal: ${stokSebelumKasir} - Beli 3)`, stokSebelumKasir - 3, sisaStokPascaBeli);
    }
}
